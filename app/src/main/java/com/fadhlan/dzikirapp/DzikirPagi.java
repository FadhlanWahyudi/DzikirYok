...
public class DzikirPagi extends AppCompatActivity {
    private AdapterDzikir adapterDzikir;
    RecyclerView pagi;
    ...
    String idDzikirpagi;
     ...
     String[] arabpagi ={"أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيم",
            ...
            "بِسْمِ اللَّهِ الرَّحْمَن==n" + "قُلْ هُوَ اللَّهُ أَحَدٌ (١) للَّهُ الصَّمَدُ (٢) لَمْ يَلِدْ وَلَمْ يُولَدْ (٣) وَلَمْ يَكُن لَّهُ كُفُوًا أَحَدٌ (٤)" ,
     ...
     String[] indopagi = {"“Aku berlindung kepada Allah dari godaan syaitan yang terkutuk.”",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idDzikirpagi = getIntent().getStringExtra("KEY");
        pagi = findViewById(R.id.pagi);
        arrayList = new ArrayList<>();
        setdatapagi();
        adapterDzikir = new AdapterDzikir(arrayList);

        pagi.setLayoutManager(new LinearLayoutManager(this));
        pagi.setHasFixedSize(true);
        pagi.setAdapter(adapterDzikir);

    }
    private void setdatapagi(){
        int count = 0;
        for (String id : arabpagi) {
            arrayList.add(new ModelDzikir(id,indopagi[count]));
            count++;
        }
    }
}
